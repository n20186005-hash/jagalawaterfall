      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          {sections.map((section, index) => (
            ...
            >
              <div className="flex-1 w-full p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border-color)' }}>
